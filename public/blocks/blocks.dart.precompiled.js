...
function dart_precompiled($collectedClasses) {
  ...
  KeyboardEvent0.prototype.get$altKey = function(receiver) {
    return receiver.altKey;
  };
  KeyboardEvent0.prototype.get$ctrlKey = function(receiver) {
    return receiver.ctrlKey;
  };
  KeyboardEvent0.prototype.get$keyLocation = function(receiver) {
    return receiver.keyLocation;
  };
  KeyboardEvent0.prototype.get$shiftKey = function(receiver) {
  ...
  function start_loadDefaultPuzzle(view_0) {
    this.view_0 = view_0;
  }
  start_loadDefaultPuzzle.builtin$cls = "start_loadDefaultPuzzle";
  if (!"name" in start_loadDefaultPuzzle)
    start_loadDefaultPuzzle.name = "start_loadDefaultPuzzle";
  $desc = $collectedClasses.start_loadDefaultPuzzle;
  if ($desc instanceof Array)
    $desc = $desc[1];
  start_loadDefaultPuzzle.prototype = $desc;
  function start_closure(inputCustomPuzzleState_1) {
    this.inputCustomPuzzleState_1 = inputCustomPuzzleState_1;
  }
  ...
  function start_closure0(view_2, inputCustomPuzzleState_3) {
    this.view_2 = view_2;
    this.inputCustomPuzzleState_3 = inputCustomPuzzleState_3;
  }
  ...
  function start_closure1(view_4, editorState_5) {
    this.view_4 = view_4;
    this.editorState_5 = editorState_5;
  }
  ...
  function start_closure2(loadDefaultPuzzle_6) {
    this.loadDefaultPuzzle_6 = loadDefaultPuzzle_6;
  }
  start_closure2.builtin$cls = "start_closure2";
  if (!"name" in start_closure2)
    start_closure2.name = "start_closure2";
  $desc = $collectedClasses.start_closure2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  start_closure2.prototype = $desc;
  function start_closure3(view_7) {
    this.view_7 = view_7;
  }
  start_closure3.builtin$cls = "start_closure3";
  if (!"name" in start_closure3)
    start_closure3.name = "start_closure3";
  $desc = $collectedClasses.start_closure3;
  if ($desc instanceof Array)
    $desc = $desc[1];
  start_closure3.prototype = $desc;
  function start_closure4() {
  }
  start_closure4.builtin$cls = "start_closure4";
  if (!"name" in start_closure4)
    start_closure4.name = "start_closure4";
  $desc = $collectedClasses.start_closure4;
  if ($desc instanceof Array)
    $desc = $desc[1];
  start_closure4.prototype = $desc;
  function start_closure5() {
  }
  start_closure5.builtin$cls = "start_closure5";
  if (!"name" in start_closure5)
    start_closure5.name = "start_closure5";
  $desc = $collectedClasses.start_closure5;
  if ($desc instanceof Array)
    $desc = $desc[1];
  start_closure5.prototype = $desc;
  function start_closure6(view_8) {
    this.view_8 = view_8;
  }
  start_closure6.builtin$cls = "start_closure6";
  if (!"name" in start_closure6)
    start_closure6.name = "start_closure6";
  $desc = $collectedClasses.start_closure6;
  if ($desc instanceof Array)
    $desc = $desc[1];
  start_closure6.prototype = $desc;
  function EditorGui(buttonMode, useHandCursor, hitArea, _graphics, _dropTarget, _children, _mouseChildren, _tabChildren, doubleClickEnabled, mouseEnabled, tabEnabled, tabIndex, _stagexl$_id, _x, _y, _pivotX, _pivotY, _scaleX, _scaleY, _skewX, _skewY, _rotation, _alpha, _visible, _off, _mask, _cache, _cacheRectangle, _cacheDebugBorder, _filters, _shadow, _compositeOperation, _stagexl$_name, _parent, _tmpMatrix, _transformationMatrix, _transformationMatrixRefresh, userData, _eventStreams) {
  ...
  EditorGui.builtin$cls = "EditorGui";
  if (!"name" in EditorGui)
    EditorGui.name = "EditorGui";
  $desc = $collectedClasses.EditorGui;
  if ($desc instanceof Array)
    $desc = $desc[1];
  EditorGui.prototype = $desc;
  function EditorGui_closure(editorState_0) {
    this.editorState_0 = editorState_0;
  }
  EditorGui_closure.builtin$cls = "EditorGui_closure";
  if (!"name" in EditorGui_closure)
    EditorGui_closure.name = "EditorGui_closure";
  $desc = $collectedClasses.EditorGui_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  EditorGui_closure.prototype = $desc;
  function EditorGui_closure0(editorState_1) {
    this.editorState_1 = editorState_1;
  }
  EditorGui_closure0.builtin$cls = "EditorGui_closure0";
  if (!"name" in EditorGui_closure0)
    EditorGui_closure0.name = "EditorGui_closure0";
  $desc = $collectedClasses.EditorGui_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  EditorGui_closure0.prototype = $desc;
  function EditorGui_closure1(editorState_2) {
    this.editorState_2 = editorState_2;
  }
  EditorGui_closure1.builtin$cls = "EditorGui_closure1";
  if (!"name" in EditorGui_closure1)
    EditorGui_closure1.name = "EditorGui_closure1";
  $desc = $collectedClasses.EditorGui_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  EditorGui_closure1.prototype = $desc;
  function Hero(stateMachine, buttonMode, useHandCursor, hitArea, _graphics, _dropTarget, _children, _mouseChildren, _tabChildren, doubleClickEnabled, mouseEnabled, tabEnabled, tabIndex, _stagexl$_id, _x, _y, _pivotX, _pivotY, _scaleX, _scaleY, _skewX, _skewY, _rotation, _alpha, _visible, _off, _mask, _cache, _cacheRectangle, _cacheDebugBorder, _filters, _shadow, _compositeOperation, _stagexl$_name, _parent, _tmpMatrix, _transformationMatrix, _transformationMatrixRefresh, userData, _eventStreams) {
  ...
  Hero.builtin$cls = "Hero";
  if (!"name" in Hero)
    Hero.name = "Hero";
  $desc = $collectedClasses.Hero;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Hero.prototype = $desc;
  function Puzzle(blockContainer, triggerContainer, floorContainer, tiles, onWinController, data, buttonMode, useHandCursor, hitArea, _graphics, _dropTarget, _children, _mouseChildren, _tabChildren, doubleClickEnabled, mouseEnabled, tabEnabled, tabIndex, _stagexl$_id, _x, _y, _pivotX, _pivotY, _scaleX, _scaleY, _skewX, _skewY, _rotation, _alpha, _visible, _off, _mask, _cache, _cacheRectangle, _cacheDebugBorder, _filters, _shadow, _compositeOperation, _stagexl$_name, _parent, _tmpMatrix, _transformationMatrix, _transformationMatrixRefresh, userData, _eventStreams) {
    this.blockContainer = blockContainer;
    this.triggerContainer = triggerContainer;
    this.floorContainer = floorContainer;
    this.tiles = tiles;
    this.onWinController = onWinController;
    this.data = data;
    this.buttonMode = buttonMode;
    this.useHandCursor = useHandCursor;
    this.hitArea = hitArea;
  ...
  Puzzle.builtin$cls = "Puzzle";
  if (!"name" in Puzzle)
    Puzzle.name = "Puzzle";
  $desc = $collectedClasses.Puzzle;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Puzzle.prototype = $desc;
  function Puzzle_Puzzle_closure() {
  }
  Puzzle_Puzzle_closure.builtin$cls = "Puzzle_Puzzle_closure";
  if (!"name" in Puzzle_Puzzle_closure)
    Puzzle_Puzzle_closure.name = "Puzzle_Puzzle_closure";
  $desc = $collectedClasses.Puzzle_Puzzle_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Puzzle_Puzzle_closure.prototype = $desc;
  function Puzzle_Puzzle_closure0(dataArray_0, tilesHorizontal_1) {
    this.dataArray_0 = dataArray_0;
    this.tilesHorizontal_1 = tilesHorizontal_1;
  }
  Puzzle_Puzzle_closure0.builtin$cls = "Puzzle_Puzzle_closure0";
  if (!"name" in Puzzle_Puzzle_closure0)
    Puzzle_Puzzle_closure0.name = "Puzzle_Puzzle_closure0";
  $desc = $collectedClasses.Puzzle_Puzzle_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Puzzle_Puzzle_closure0.prototype = $desc;
  function Puzzle$_private_closure(data_0, tilesHorizontal_1) {
    this.data_0 = data_0;
    this.tilesHorizontal_1 = tilesHorizontal_1;
  }
  Puzzle$_private_closure.builtin$cls = "Puzzle$_private_closure";
  if (!"name" in Puzzle$_private_closure)
    Puzzle$_private_closure.name = "Puzzle$_private_closure";
  $desc = $collectedClasses.Puzzle$_private_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Puzzle$_private_closure.prototype = $desc;
  function Puzzle$_private__closure(data_2, y_3) {
    this.data_2 = data_2;
    this.y_3 = y_3;
  }
  Puzzle$_private__closure.builtin$cls = "Puzzle$_private__closure";
  if (!"name" in Puzzle$_private__closure)
    Puzzle$_private__closure.name = "Puzzle$_private__closure";
  $desc = $collectedClasses.Puzzle$_private__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Puzzle$_private__closure.prototype = $desc;
  function Puzzle$_private_closure0() {
  }
  Puzzle$_private_closure0.builtin$cls = "Puzzle$_private_closure0";
  if (!"name" in Puzzle$_private_closure0)
    Puzzle$_private_closure0.name = "Puzzle$_private_closure0";
  $desc = $collectedClasses.Puzzle$_private_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Puzzle$_private_closure0.prototype = $desc;
  function Puzzle$_private_closure1(this_4) {
    this.this_4 = this_4;
  }
  Puzzle$_private_closure1.builtin$cls = "Puzzle$_private_closure1";
  if (!"name" in Puzzle$_private_closure1)
    Puzzle$_private_closure1.name = "Puzzle$_private_closure1";
  $desc = $collectedClasses.Puzzle$_private_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Puzzle$_private_closure1.prototype = $desc;
  function Puzzle_encode_closure() {
  }
  Puzzle_encode_closure.builtin$cls = "Puzzle_encode_closure";
  if (!"name" in Puzzle_encode_closure)
    Puzzle_encode_closure.name = "Puzzle_encode_closure";
  $desc = $collectedClasses.Puzzle_encode_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Puzzle_encode_closure.prototype = $desc;
  function Puzzle_encode__closure() {
  }
  Puzzle_encode__closure.builtin$cls = "Puzzle_encode__closure";
  if (!"name" in Puzzle_encode__closure)
    Puzzle_encode__closure.name = "Puzzle_encode__closure";
  $desc = $collectedClasses.Puzzle_encode__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Puzzle_encode__closure.prototype = $desc;
  function Tile(block, trigger, floor) {
    this.block = block;
  ...
  if ($desc instanceof Array)
    $desc = $desc[1];
  Tile.prototype = $desc;
  Tile.prototype.get$block = function() {
    return this.block;
  };
  Tile.prototype.set$block = function(v) {
    return this.block = v;
  };
  Tile.prototype.get$trigger = function() {
    return this.trigger;
  };
  Tile.prototype.get$floor = function(receiver) {
    return this.floor;
  };
  function Block(once, moveable, dir, hasMoved, stateMachine, buttonMode, useHandCursor, hitArea, _graphics, _dropTarget, _children, _mouseChildren, _tabChildren, doubleClickEnabled, mouseEnabled, tabEnabled, tabIndex, _stagexl$_id, _x, _y, _pivotX, _pivotY, _scaleX, _scaleY, _skewX, _skewY, _rotation, _alpha, _visible, _off, _mask, _cache, _cacheRectangle, _cacheDebugBorder, _filters, _shadow, _compositeOperation, _stagexl$_name, _parent, _tmpMatrix, _transformationMatrix, _transformationMatrixRefresh, userData, _eventStreams) {
    this.once = once;
  ...
  function Trigger(_blocks$_type, bm, buttonMode, useHandCursor, hitArea, _graphics, _dropTarget, _children, _mouseChildren, _tabChildren, doubleClickEnabled, mouseEnabled, tabEnabled, tabIndex, _stagexl$_id, _x, _y, _pivotX, _pivotY, _scaleX, _scaleY, _skewX, _skewY, _rotation, _alpha, _visible, _off, _mask, _cache, _cacheRectangle, _cacheDebugBorder, _filters, _shadow, _compositeOperation, _stagexl$_name, _parent, _tmpMatrix, _transformationMatrix, _transformationMatrixRefresh, userData, _eventStreams) {
    this._blocks$_type = _blocks$_type;
    this.bm = bm;
    this.buttonMode = buttonMode;
    this.useHandCursor = useHandCursor;
    this.hitArea = hitArea;
  ...
  Trigger.builtin$cls = "Trigger";
  if (!"name" in Trigger)
    Trigger.name = "Trigger";
  $desc = $collectedClasses.Trigger;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Trigger.prototype = $desc;
  function Floor(_blocks$_type, bm, buttonMode, useHandCursor, hitArea, _graphics, _dropTarget, _children, _mouseChildren, _tabChildren, doubleClickEnabled, mouseEnabled, tabEnabled, tabIndex, _stagexl$_id, _x, _y, _pivotX, _pivotY, _scaleX, _scaleY, _skewX, _skewY, _rotation, _alpha, _visible, _off, _mask, _cache, _cacheRectangle, _cacheDebugBorder, _filters, _shadow, _compositeOperation, _stagexl$_name, _parent, _tmpMatrix, _transformationMatrix, _transformationMatrixRefresh, userData, _eventStreams) {
    this._blocks$_type = _blocks$_type;
    this.bm = bm;
    this.buttonMode = buttonMode;
    this.useHandCursor = useHandCursor;
  ...
  Floor.builtin$cls = "Floor";
  if (!"name" in Floor)
    Floor.name = "Floor";
  $desc = $collectedClasses.Floor;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Floor.prototype = $desc;
  function Resources_load_closure(then_0) {
    this.then_0 = then_0;
  }
  Resources_load_closure.builtin$cls = "Resources_load_closure";
  if (!"name" in Resources_load_closure)
    Resources_load_closure.name = "Resources_load_closure";
  $desc = $collectedClasses.Resources_load_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Resources_load_closure.prototype = $desc;
  function Resources_load__extractSprites(zero_1) {
    this.zero_1 = zero_1;
  }
  Resources_load__extractSprites.builtin$cls = "Resources_load__extractSprites";
  if (!"name" in Resources_load__extractSprites)
    Resources_load__extractSprites.name = "Resources_load__extractSprites";
  $desc = $collectedClasses.Resources_load__extractSprites;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Resources_load__extractSprites.prototype = $desc;
  function Resources_load__extractSprites_closure(zero_2, ss_3) {
    this.zero_2 = zero_2;
    this.ss_3 = ss_3;
  }
  Resources_load__extractSprites_closure.builtin$cls = "Resources_load__extractSprites_closure";
  if (!"name" in Resources_load__extractSprites_closure)
    Resources_load__extractSprites_closure.name = "Resources_load__extractSprites_closure";
  $desc = $collectedClasses.Resources_load__extractSprites_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Resources_load__extractSprites_closure.prototype = $desc;
  function StateMachine(obj, _state) {
    this.obj = obj;
    this._state = _state;
  }
  StateMachine.builtin$cls = "StateMachine";
  if (!"name" in StateMachine)
    StateMachine.name = "StateMachine";
  $desc = $collectedClasses.StateMachine;
  if ($desc instanceof Array)
    $desc = $desc[1];
  StateMachine.prototype = $desc;
  function State() {
  }
  State.builtin$cls = "State";
  if (!"name" in State)
    State.name = "State";
  $desc = $collectedClasses.State;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  function NullState(stateMachine, obj) {
    this.stateMachine = stateMachine;
    this.obj = obj;
  }
  NullState.builtin$cls = "NullState";
  if (!"name" in NullState)
    NullState.name = "NullState";
  $desc = $collectedClasses.NullState;
  if ($desc instanceof Array)
    $desc = $desc[1];
  NullState.prototype = $desc;
  function MovingState(speed, dx, dy, stateMachine, obj) {
    this.speed = speed;
    this.dx = dx;
    this.dy = dy;
    this.stateMachine = stateMachine;
  ...
  MovingState.builtin$cls = "MovingState";
  if (!"name" in MovingState)
    MovingState.name = "MovingState";
  $desc = $collectedClasses.MovingState;
  if ($desc instanceof Array)
    $desc = $desc[1];
  MovingState.prototype = $desc;
  function HeroWaitingState(pushingOnBlockTicker, stateMachine, obj) {
    this.pushingOnBlockTicker = pushingOnBlockTicker;
    this.stateMachine = stateMachine;
    this.obj = obj;
  }
  HeroWaitingState.builtin$cls = "HeroWaitingState";
  if (!"name" in HeroWaitingState)
    HeroWaitingState.name = "HeroWaitingState";
  $desc = $collectedClasses.HeroWaitingState;
  if ($desc instanceof Array)
    $desc = $desc[1];
  HeroWaitingState.prototype = $desc;
  function ViewObject(stateMachine, buttonMode, useHandCursor, hitArea, _graphics, _dropTarget, _children, _mouseChildren, _tabChildren, doubleClickEnabled, mouseEnabled, tabEnabled, tabIndex, _stagexl$_id, _x, _y, _pivotX, _pivotY, _scaleX, _scaleY, _skewX, _skewY, _rotation, _alpha, _visible, _off, _mask, _cache, _cacheRectangle, _cacheDebugBorder, _filters, _shadow, _compositeOperation, _stagexl$_name, _parent, _tmpMatrix, _transformationMatrix, _transformationMatrixRefresh, userData, _eventStreams) {
    this.stateMachine = stateMachine;
    this.buttonMode = buttonMode;
    this.useHandCursor = useHandCursor;
    this.hitArea = hitArea;
  ...
  ViewObject.builtin$cls = "ViewObject";
  if (!"name" in ViewObject)
    ViewObject.name = "ViewObject";
  $desc = $collectedClasses.ViewObject;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ViewObject.prototype = $desc;
  function ViewObject_hide_closure() {
  }
  ViewObject_hide_closure.builtin$cls = "ViewObject_hide_closure";
  if (!"name" in ViewObject_hide_closure)
    ViewObject_hide_closure.name = "ViewObject_hide_closure";
  $desc = $collectedClasses.ViewObject_hide_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ViewObject_hide_closure.prototype = $desc;
  function ViewObject_show_closure() {
  }
  ViewObject_show_closure.builtin$cls = "ViewObject_show_closure";
  if (!"name" in ViewObject_show_closure)
    ViewObject_show_closure.name = "ViewObject_show_closure";
  $desc = $collectedClasses.ViewObject_show_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ViewObject_show_closure.prototype = $desc;
  function ViewState() {
  }
  ViewState.builtin$cls = "ViewState";
  if (!"name" in ViewState)
    ViewState.name = "ViewState";
  $desc = $collectedClasses.ViewState;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ViewState.prototype = $desc;
  function PlayingGameState(puzzle, onWinSubscription, view, stateMachine, obj) {
    this.puzzle = puzzle;
    this.onWinSubscription = onWinSubscription;
    this.view = view;
    this.stateMachine = stateMachine;
    this.obj = obj;
  }
  PlayingGameState.builtin$cls = "PlayingGameState";
  if (!"name" in PlayingGameState)
    PlayingGameState.name = "PlayingGameState";
  $desc = $collectedClasses.PlayingGameState;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PlayingGameState.prototype = $desc;
  function PlayingGameState_enter_closure() {
  }
  PlayingGameState_enter_closure.builtin$cls = "PlayingGameState_enter_closure";
  if (!"name" in PlayingGameState_enter_closure)
    PlayingGameState_enter_closure.name = "PlayingGameState_enter_closure";
  $desc = $collectedClasses.PlayingGameState_enter_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PlayingGameState_enter_closure.prototype = $desc;
  function PlayingGameState_update_closure() {
  }
  PlayingGameState_update_closure.builtin$cls = "PlayingGameState_update_closure";
  if (!"name" in PlayingGameState_update_closure)
    PlayingGameState_update_closure.name = "PlayingGameState_update_closure";
  $desc = $collectedClasses.PlayingGameState_update_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PlayingGameState_update_closure.prototype = $desc;
  function PlayingGameState_update_closure0() {
  }
  PlayingGameState_update_closure0.builtin$cls = "PlayingGameState_update_closure0";
  if (!"name" in PlayingGameState_update_closure0)
    PlayingGameState_update_closure0.name = "PlayingGameState_update_closure0";
  $desc = $collectedClasses.PlayingGameState_update_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PlayingGameState_update_closure0.prototype = $desc;
  function PlayingGameState_update_closure1() {
  }
  PlayingGameState_update_closure1.builtin$cls = "PlayingGameState_update_closure1";
  if (!"name" in PlayingGameState_update_closure1)
    PlayingGameState_update_closure1.name = "PlayingGameState_update_closure1";
  $desc = $collectedClasses.PlayingGameState_update_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PlayingGameState_update_closure1.prototype = $desc;
  function EditorState(preview, currentSelectionIndex, currentSelectionType, view, stateMachine, obj) {
  ...
  EditorState.builtin$cls = "EditorState";
  if (!"name" in EditorState)
    EditorState.name = "EditorState";
  $desc = $collectedClasses.EditorState;
  if ($desc instanceof Array)
    $desc = $desc[1];
  EditorState.prototype = $desc;
  ...
  function EditorState_update_closure() {
  }
  EditorState_update_closure.builtin$cls = "EditorState_update_closure";
  if (!"name" in EditorState_update_closure)
    EditorState_update_closure.name = "EditorState_update_closure";
  $desc = $collectedClasses.EditorState_update_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  EditorState_update_closure.prototype = $desc;
  function EditorState_update_closure0() {
  }
  EditorState_update_closure0.builtin$cls = "EditorState_update_closure0";
  if (!"name" in EditorState_update_closure0)
    EditorState_update_closure0.name = "EditorState_update_closure0";
  $desc = $collectedClasses.EditorState_update_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  EditorState_update_closure0.prototype = $desc;
  function EditorState_update_closure1() {
  }
  EditorState_update_closure1.builtin$cls = "EditorState_update_closure1";
  if (!"name" in EditorState_update_closure1)
    EditorState_update_closure1.name = "EditorState_update_closure1";
  $desc = $collectedClasses.EditorState_update_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  EditorState_update_closure1.prototype = $desc;
  function InputCustomPuzzleState(view, stateMachine, obj) {
    this.view = view;
    this.stateMachine = stateMachine;
    this.obj = obj;
  }
  InputCustomPuzzleState.builtin$cls = "InputCustomPuzzleState";
  if (!"name" in InputCustomPuzzleState)
    InputCustomPuzzleState.name = "InputCustomPuzzleState";
  $desc = $collectedClasses.InputCustomPuzzleState;
  if ($desc instanceof Array)
    $desc = $desc[1];
  InputCustomPuzzleState.prototype = $desc;
  ...
  function _BroadcastSubscription(_eventState, _async$_next, _previous, _controller, _async$_onData, _onError, _onDone, _zone, _async$_state, _cancelFuture, _pending) {
  ...
  function _BroadcastStreamController(_async$_next, _previous) {
    this._async$_next = _async$_next;
    this._previous = _previous;
  }
  ...
  function _SyncBroadcastStreamController(_onListen, _onCancel, _async$_state, _async$_next, _previous, _addStreamState, _doneFuture) {
  ...
  function _AsyncBroadcastStreamController(_onListen, _onCancel, _async$_state, _async$_next, _previous, _addStreamState, _doneFuture) {
    this._onListen = _onListen;
    this._onCancel = _onCancel;
    this._async$_state = _async$_state;
    this._async$_next = _async$_next;
  ...
  function _AsBroadcastStreamController(_pending, _onListen, _onCancel, _async$_state, _async$_next, _previous, _addStreamState, _doneFuture) {
    this._pending = _pending;
    this._onListen = _onListen;
    this._onCancel = _onCancel;
    this._async$_state = _async$_state;
  ...
  function _AsyncStreamController(_onListen, _onPause, _onResume, _onCancel, _varData, _async$_state, _doneFuture) {
    this._onListen = _onListen;
  ...
  function _SyncStreamController(_onListen, _onPause, _onResume, _onCancel, _varData, _async$_state, _doneFuture) {
    this._onListen = _onListen;
    this._onPause = _onPause;
    this._onResume = _onResume;
    this._onCancel = _onCancel;
  ...
  function _NoCallbackAsyncStreamController(_varData, _async$_state, _doneFuture) {
    this._varData = _varData;
    this._async$_state = _async$_state;
    this._doneFuture = _doneFuture;
  }
  ...
  function _NoCallbackSyncStreamController(_varData, _async$_state, _doneFuture) {
    this._varData = _varData;
    this._async$_state = _async$_state;
    this._doneFuture = _doneFuture;
  }
  ...
  function _ControllerSubscription(_controller, _async$_onData, _onError, _onDone, _zone, _async$_state, _cancelFuture, _pending) {
    this._controller = _controller;
    this._async$_onData = _async$_onData;
    this._onError = _onError;
    this._onDone = _onDone;
  ...
  function _BufferingStreamSubscription(_async$_onData, _onError, _onDone, _zone, _async$_state, _cancelFuture, _pending) {
    this._async$_onData = _async$_onData;
    this._onError = _onError;
    this._onDone = _onDone;
    this._zone = _zone;
  ...
  function _ForwardingStreamSubscription(_stream, _subscription, _async$_onData, _onError, _onDone, _zone, _async$_state, _cancelFuture, _pending) {
    this._stream = _stream;
    this._subscription = _subscription;
    this._async$_onData = _async$_onData;
    this._onError = _onError;
  ...
  function LinkedHashMapCell(_key, _value, _next, _collection$_previous) {
    this._key = _key;
    this._value = _value;
    this._next = _next;
  ...
  function LinkedHashSetCell(_element, _next, _collection$_previous) {
  ...
  function BitmapData(_width, _height, _transparent, _pixelRatio, _pixelRatioSource, _renderMode, _destinationWidth, _destinationHeight, _destinationX, _destinationY, _sourceX, _sourceY, _sourceWidth, _sourceHeight, _stagexl$_source, _context) {
    this._width = _width;
    ...
    this._stagexl$_source = _stagexl$_source;
  ...
  function KeyboardEvent(_altKey, _ctrlKey, _shiftKey, _commandKey, _controlKey, _charCode, _keyCode, _keyLocation, _type, _bubbles, _eventPhase, _stagexl$_target, _currentTarget, _stopsPropagation, _stopsImmediatePropagation) {
    this._altKey = _altKey;
    this._ctrlKey = _ctrlKey;
    this._shiftKey = _shiftKey;
    this._commandKey = _commandKey;
    this._controlKey = _controlKey;
    this._charCode = _charCode;
    this._keyCode = _keyCode;
    this._keyLocation = _keyLocation;
    this._type = _type;
    this._bubbles = _bubbles;
    this._eventPhase = _eventPhase;
    this._stagexl$_target = _stagexl$_target;
  ...
  function TextEvent(_text, _type, _bubbles, _eventPhase, _stagexl$_target, _currentTarget, _stopsPropagation, _stopsImmediatePropagation) {
    this._text = _text;
    this._type = _type;
    this._bubbles = _bubbles;
    this._eventPhase = _eventPhase;
