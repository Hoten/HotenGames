...
function dart_precompiled($collectedClasses) {
  ...
  function Cell(neighbors, plusWrappedNeighbors, state, buttonMode, useHandCursor, hitArea, _graphics, _dropTarget, _children, _mouseChildren, _tabChildren, doubleClickEnabled, mouseEnabled, tabEnabled, tabIndex, _stagexl$_id, _x, _y, _pivotX, _pivotY, _scaleX, _scaleY, _skewX, _skewY, _rotation, _alpha, _visible, _off, _mask, _cache, _cacheRectangle, _cacheDebugBorder, _filters, _shadow, _compositeOperation, _name, _parent, _tmpMatrix, _transformationMatrix, _transformationMatrixRefresh, _eventStreams) {
    this.neighbors = neighbors;
    this.plusWrappedNeighbors = plusWrappedNeighbors;
    this.state = state;
  ...
  if ($desc instanceof Array)
    $desc = $desc[1];
  Cell.prototype = $desc;
  Cell.prototype.get$state = function(receiver) {
    return this.state;
  };
  function Life(cells, born, stays, cellSize, speed, grid, size, timer, wrap, lastMouseX, lastMouseY, buttonMode, useHandCursor, hitArea, _graphics, _dropTarget, _children, _mouseChildren, _tabChildren, doubleClickEnabled, mouseEnabled, tabEnabled, tabIndex, _stagexl$_id, _x, _y, _pivotX, _pivotY, _scaleX, _scaleY, _skewX, _skewY, _rotation, _alpha, _visible, _off, _mask, _cache, _cacheRectangle, _cacheDebugBorder, _filters, _shadow, _compositeOperation, _name, _parent, _tmpMatrix, _transformationMatrix, _transformationMatrixRefresh, _eventStreams) {
    this.cells = cells;
    this.born = born;
    this.stays = stays;
  ...
  Life.builtin$cls = "Life";
  if (!"name" in Life)
    Life.name = "Life";
  $desc = $collectedClasses.Life;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Life.prototype = $desc;
  function Life_closure(this_0, grid_1) {
    this.this_0 = this_0;
    this.grid_1 = grid_1;
  }
  Life_closure.builtin$cls = "Life_closure";
  if (!"name" in Life_closure)
    Life_closure.name = "Life_closure";
  $desc = $collectedClasses.Life_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Life_closure.prototype = $desc;
  function Life__closure(this_2) {
    this.this_2 = this_2;
  }
  Life__closure.builtin$cls = "Life__closure";
  if (!"name" in Life__closure)
    Life__closure.name = "Life__closure";
  $desc = $collectedClasses.Life__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Life__closure.prototype = $desc;
  function Life_play_closure(this_0) {
    this.this_0 = this_0;
  }
  Life_play_closure.builtin$cls = "Life_play_closure";
  if (!"name" in Life_play_closure)
    Life_play_closure.name = "Life_play_closure";
  $desc = $collectedClasses.Life_play_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Life_play_closure.prototype = $desc;
  function Life_determineNextState_closure() {
  }
  Life_determineNextState_closure.builtin$cls = "Life_determineNextState_closure";
  if (!"name" in Life_determineNextState_closure)
    Life_determineNextState_closure.name = "Life_determineNextState_closure";
  $desc = $collectedClasses.Life_determineNextState_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Life_determineNextState_closure.prototype = $desc;
  function Life_initializeCells_closure(this_0) {
    this.this_0 = this_0;
  }
  Life_initializeCells_closure.builtin$cls = "Life_initializeCells_closure";
  if (!"name" in Life_initializeCells_closure)
    Life_initializeCells_closure.name = "Life_initializeCells_closure";
  $desc = $collectedClasses.Life_initializeCells_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Life_initializeCells_closure.prototype = $desc;
  function Life_initializeCells__closure() {
  }
  Life_initializeCells__closure.builtin$cls = "Life_initializeCells__closure";
  if (!"name" in Life_initializeCells__closure)
    Life_initializeCells__closure.name = "Life_initializeCells__closure";
  $desc = $collectedClasses.Life_initializeCells__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Life_initializeCells__closure.prototype = $desc;
  function Life_initializeCells_closure0() {
  }
  Life_initializeCells_closure0.builtin$cls = "Life_initializeCells_closure0";
  if (!"name" in Life_initializeCells_closure0)
    Life_initializeCells_closure0.name = "Life_initializeCells_closure0";
  $desc = $collectedClasses.Life_initializeCells_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Life_initializeCells_closure0.prototype = $desc;
  function Life_clear_closure() {
  }
  Life_clear_closure.builtin$cls = "Life_clear_closure";
  if (!"name" in Life_clear_closure)
    Life_clear_closure.name = "Life_clear_closure";
  $desc = $collectedClasses.Life_clear_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Life_clear_closure.prototype = $desc;
  ...
  function getRules_allUniqueCharacters() {
  }
  getRules_allUniqueCharacters.builtin$cls = "getRules_allUniqueCharacters";
  if (!"name" in getRules_allUniqueCharacters)
    getRules_allUniqueCharacters.name = "getRules_allUniqueCharacters";
  $desc = $collectedClasses.getRules_allUniqueCharacters;
  if ($desc instanceof Array)
    $desc = $desc[1];
  getRules_allUniqueCharacters.prototype = $desc;
  function getRules_closure() {
  }
  getRules_closure.builtin$cls = "getRules_closure";
  if (!"name" in getRules_closure)
    getRules_closure.name = "getRules_closure";
  $desc = $collectedClasses.getRules_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  getRules_closure.prototype = $desc;
  function getRules_closure0() {
  }
  getRules_closure0.builtin$cls = "getRules_closure0";
  if (!"name" in getRules_closure0)
    getRules_closure0.name = "getRules_closure0";
  $desc = $collectedClasses.getRules_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  getRules_closure0.prototype = $desc;
  function Animatable() {
  }
  ...
  function EventStreamSubscription(_stagexl$_pauseCount, _canceled, _captures, _eventStream, _eventListener) {
